  ...
  return (
    <>
      ...
      <section className="flex flex-col items-center justify-center min-h-[60vh] py-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-primary font-serif">Venta Mayorista</h1>
        <p className="text-lg md:text-xl mb-8 text-center max-w-xl">
          ¡Pronto podrás acceder a precios y beneficios exclusivos para comercios y restaurantes!<br />
          Estamos trabajando para ofrecerte la mejor experiencia mayorista.
        </p>
